...
<div class = "topDiv">
	<div class="secondDiv"><!-- 覆盖个div，添加透明度 -->
		<br>
		<p align="center" class="loginTitle" style="margin-bottom: 5px;"><font color="#4ac9ff">Xiaoxiao</font><font color="#ff508b">bike</font></p>
		<p align="center" class="slogan" style="margin-bottom: 30px;">江西应用科技学院共享单车管理系统</p>
		<form action="admin/login" method="post" onsubmit="return submitForm();">
			...
			<!--尾注-->
			<p align="center" style="color:#7f7f7f;position: absolute;top: 95%;right: 1%">copyright@筱筱归档</p>
		</form>
	</div>
</div>
</body>
